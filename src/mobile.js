...
page.viewportSize = {width: 1080, height: 10000000};
...
page.onConsoleMessage = function (msg, lineNum, sourceId) {
    ...
    if (msg == 'eme_render') {
        ...
        page.render(output + "z.png", {format: 'png', quality: 80});
        page.close();
        phantom.exit();
    }
};
        ...
        window.onload = function () {
            ...
            window.setTimeout(function () {
                if (Element.prototype.remove = function () {
                    ...
                    var screenHeight = (10000000 || window.screen.availHeight), step = 500, currentToTop = 0, finalHeight = 0, timer = setInterval(function (e) {
