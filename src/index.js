...
address = "https://mariedalgar.m.tmall.com/?ajson=1&parentCatId=0";
output = system.args[1];
page.viewportSize = {width: 2560, height: 10000000000};
...
page.open(address, function (status) {
    ...
    var bb = page.evaluate(function () {
        ...
        if (Element.prototype.remove = function () {
            ...
            var screenHeight = (10000000000 || window.screen.availHeight), step = 500, currentToTop = 0, finalHeight = 0, timer = setInterval(function (e) {
